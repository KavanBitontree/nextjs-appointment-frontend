...
import { LogOut, User, Calendar, DollarSign, Users, Clock } from "lucide-react";
        ...
        >
          <div className="flex items-center justify-between mb-8">
            <div>
              ...
              <p className="text-slate-700">Welcome back, Dr. {user?.email}</p>
            </div>
            <button
          ...
          <div className="grid md:grid-cols-4 gap-6 mb-8">
            ...
            >
              <div className="flex items-center gap-4">
                ...
                <div>
                  <p className="text-sm text-slate-600">Patients Today</p>
          ...
          <div className="bg-white rounded-2xl p-8 border border-slate-200 mb-8">
            <div className="flex items-center gap-4 mb-6">
              ...
              <div>
                ...
                <p className="text-slate-600">Doctor Account</p>
              </div>
            </div>
