...
import { getPatientProfile, updatePatientProfile } from "@/lib/profile_api";
...
import PatientProfileEdit from "@/components/patient/profile/PatientProfileEdit";
...
export default function PatientProfilePage() {
  ...
  const handleSave = async (updates: PatientProfileUpdateData) => {
    setSaving(true);

    try {
      const updatedProfile = await updatePatientProfile(updates);
