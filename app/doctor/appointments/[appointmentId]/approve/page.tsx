              ...
              <div className="bg-blue-50 border border-blue-200 rounded-lg p-4 mb-6">
                ...
                <ul className="text-sm text-blue-800 space-y-2">
                  <li className="flex items-start">
                    ...
                    <span>Patient will receive an email with payment link</span>
                  </li>
                  <li className="flex items-start">
                    <svg
                      className="w-5 h-5 text-blue-600 mr-2 flex-shrink-0 mt-0.5"
                    ...
                    <span>
                      Once payment is completed, appointment will be confirmed
                    </span>
                  </li>
                  <li className="flex items-start">
                    <svg
                    ...
                    <span>
                      ...
                      {approvalData.payment_timeout_minutes} minutes,
                      appointment will be auto-cancelled
                    </span>
                  </li>
                  <li className="flex items-start">
                    <svg
                    ...
                    <span>
                      You'll be notified once the appointment is confirmed
                    </span>
                  </li>
                </ul>
              </div>
                  ...
                  <div className="ml-3">
                    ...
                    <div className="mt-2 text-sm text-red-700">
                      <ul className="list-disc pl-5 space-y-1">
                        <li>The 24-hour approval window may have expired</li>
                        <li>The appointment may have already been processed</li>
                        <li>The appointment may have been cancelled</li>
                      </ul>
                    </div>
                  </div>
                </div>
